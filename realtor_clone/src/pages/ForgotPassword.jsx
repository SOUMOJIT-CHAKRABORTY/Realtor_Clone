...
export default function ForgotPassword() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      toast.error("Couldn't sent email ");
    }
  }
  return (
    <section>
      <h1 className='text-3xl mt-6 font-bold'>Forgot Password</h1>
      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        <form onSubmit={onSubmit}>
          ...
          <button type='submit' className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase shadow-md rounded hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800 '> Reset Password</button>
