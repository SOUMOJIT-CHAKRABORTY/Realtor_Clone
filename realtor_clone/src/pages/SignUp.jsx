      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        ...
        <input type="text" className='w-full px-4 py-2 mb-6 text-xl text-gray-700 bg-white border-grey-300 rounded transition ease-in-out' id='name' value={name} onChange = {onChange} placeholder="Full Name" />
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
            <p className='text-left mb-6'>Have an account?
          ...
          <button type='submit' className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase shadow-md rounded hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800 '> Sign Up</button>
