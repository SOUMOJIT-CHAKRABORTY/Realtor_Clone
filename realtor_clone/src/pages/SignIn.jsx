...
export default function SignIn() {
  ...
  return (
    <section>
      <h1 className='text-3xl mt-6 font-bold'>Sign In</h1>
      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        <form >
          ...
          <input type={showPassword ? "text" : "password"} className='w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-grey-300 rounded transition ease-in-out' id='password' value={password} onChange = {onChange} placeholder="Password" />
          {showPassword ? (
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
            <p className='text-left mb-6'>Don't have an account?
          ...
          <button type='submit' onClick={onSubmit} className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase shadow-md rounded hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800 '> Sign In</button>
